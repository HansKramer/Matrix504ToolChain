...
#define __GMP_CC "ccache arm-angstrom-linux-gnueabi-gcc -march=armv5te -mtune=arm926ej-s -mthumb-interwork -mno-thumb -std=gnu99"
#define __GMP_CFLAGS "-isystem/OE/angstrom-dev/staging/armv5te-angstrom-linux-gnueabi/usr/include -fexpensive-optimizations -frename-registers -fomit-frame-pointer -O2 -ggdb3"
