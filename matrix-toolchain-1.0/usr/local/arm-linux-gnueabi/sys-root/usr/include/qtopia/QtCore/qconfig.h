...
#if defined(QT_NO_QWS_DECORATION_DEFAULT) && defined(QT_QWS_DECORATION_DEFAULT)
# undef QT_NO_QWS_DECORATION_DEFAULT
#elif !defined(QT_NO_QWS_DECORATION_DEFAULT) && !defined(QT_QWS_DECORATION_DEFAULT)
# define QT_NO_QWS_DECORATION_DEFAULT
#endif

#if defined(QT_NO_QWS_DECORATION_WINDOWS) && defined(QT_QWS_DECORATION_WINDOWS)
# undef QT_NO_QWS_DECORATION_WINDOWS
#elif !defined(QT_NO_QWS_DECORATION_WINDOWS) && !defined(QT_QWS_DECORATION_WINDOWS)
