...
#define UNAMEPROG "/home/ace.yang/stuff/tmp/staging/i686-linux/usr/bin/uname"
...
#define NETSNMP_SYS_CONTACT "ace.yang@"
...
#define NETSNMP_CONFIGURE_OPTIONS "'--build=i686-linux' '--host=arm-linux-gnueabi' '--target=arm-linux-gnueabi' '--prefix=/usr' '--exec_prefix=/usr' '--bindir=/usr/bin' '--sbindir=/usr/sbin' '--libexecdir=/usr/libexec' '--datadir=/usr/share' '--sysconfdir=/etc' '--sharedstatedir=/usr/com' '--localstatedir=/var' '--libdir=/usr/lib' '--includedir=/usr/include' '--oldincludedir=/usr/include' '--infodir=/usr/share/info' '--mandir=/usr/share/man' '--enable-shared' '--disable-manuals' '--with-defaults' '--disable-embedded-perl' '--with-perl-modules=no' '--with-endianness=little' 'CC=arm-linux-gnueabi-gcc -march=armv5te -mtune=arm926ej-s -mthumb-interwork -mno-thumb -L/home/ace.yang/stuff/tmp/staging/armv5te-linux-gnueabi/usr/lib -Wl,-rpath-link,/home/ace.yang/stuff/tmp/staging/armv5te-linux-gnueabi/usr/lib -Wl,-O1 -Wl,--hash-style=gnu' 'CFLAGS=-isystem/home/ace.yang/stuff/tmp/staging/armv5te-linux-gnueabi/usr/include -fexpensive-optimizations -frename-registers -fomit-frame-pointer -O2 -ggdb3' 'CPPFLAGS=-isystem/home/ace.yang/stuff/tmp/staging/armv5te-linux-gnueabi/usr/include' 'CPP=arm-linux-gnueabi-gcc -E' 'CXXFLAGS=-isystem/home/ace.yang/stuff/tmp/staging/armv5te-linux-gnueabi/usr/include -fexpensive-optimizations -frename-registers -fomit-frame-pointer -O2 -ggdb3 -fpermissive -fvisibility-inlines-hidden' 'CXX=arm-linux-gnueabi-g++ -march=armv5te -mtune=arm926ej-s -mthumb-interwork -mno-thumb -L/home/ace.yang/stuff/tmp/staging/armv5te-linux-gnueabi/usr/lib -Wl,-rpath-link,/home/ace.yang/stuff/tmp/staging/armv5te-linux-gnueabi/usr/lib -Wl,-O1 -Wl,--hash-style=gnu' 'F77=arm-linux-gnueabi-g77 -march=armv5te -mtune=arm926ej-s -mthumb-interwork -mno-thumb -L/home/ace.yang/stuff/tmp/staging/armv5te-linux-gnueabi/usr/lib -Wl,-rpath-link,/home/ace.yang/stuff/tmp/staging/armv5te-linux-gnueabi/usr/lib -Wl,-O1 -Wl,--hash-style=gnu' 'LDFLAGS=-L/home/ace.yang/stuff/tmp/staging/armv5te-linux-gnueabi/usr/lib -Wl,-rpath-link,/home/ace.yang/stuff/tmp/staging/armv5te-linux-gnueabi/usr/lib -Wl,-O1 -Wl,--hash-style=gnu' 'build_alias=i686-linux' 'host_alias=arm-linux-gnueabi' 'target_alias=arm-linux-gnueabi'"
